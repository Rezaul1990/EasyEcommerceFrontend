...
import { BarChart3, Boxes, ClipboardList, LayoutDashboard, LockKeyhole, LogOut, Menu, Monitor, PackageSearch, Settings, ShieldCheck, TicketPercent, Users, X } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/visual-editor", label: "Visual Editor", module: "content", icon: Monitor },
